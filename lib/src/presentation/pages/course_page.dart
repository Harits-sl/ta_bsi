...
class CoursePage extends StatelessWidget {
  const CoursePage(this.arguments, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> listDummyCourse = [
      {
        'id': 'materi-1',
